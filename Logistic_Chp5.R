...
# Survey in 1974/1975 asked is agreed with the statement 'Women should take care of
# running their homes and leave running the country up to men'. The question of interest
# is if whether the responses of men and women differ and how years of education affect 
# the response 
...
# definition of a plot of a fitted object definition function 
# myplot function 
